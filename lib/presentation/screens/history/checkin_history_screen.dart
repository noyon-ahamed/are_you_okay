...
class CheckinHistoryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: Builder(
        builder: (context) {
          if (checkinsAsync is CheckInLoading || checkinsAsync is CheckInInitial) {
            return const Center(child: CircularProgressIndicator());
          } else if (checkinsAsync is CheckInSuccess) {
          ...
          } else if (checkinsAsync is CheckInError) {
            return Center(
              child: Text('ত্রুটি: ${(checkinsAsync as CheckInError).message}'),
            );
          }
